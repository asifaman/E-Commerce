...
<section id="content">
  <div class="main">
   ...
   <div id="text">
   &nbsp&nbspE-Book
   <a href=" <?php echo base_url().'view_all_e_book';?>""><div align="right" id="cataheader1"><div id="text1"> View all &nbsp&nbsp </div>  </div>
   </div>
   </div>
...
<div align="left">
	...
	<table border="0" cellpadding="2px" width="600px">
		<?php 
			foreach ($p_e_book_view_all as $product){
				$id = $product['serial'];
				$name = $product['name'];
    	...
    	<tr>
            ...
            <td ><br /><b style="color:#000"><?php echo $name; ?></b><br />
                    ...
                    <?php
					echo form_open('products_view/ebook_view_details/3');	//here 1 define for dry_fish
