...
<section id="content">
  <div class="main">
   ...
   <div id="text">
   &nbsp&nbspElectronic
   <a href="<?php echo base_url().'view_all_electronic';?>""><div align="right" id="cataheader1"><div id="text1"> View all &nbsp&nbsp </div>  </div>
   </div>
   </div>
...
<div align="left">
	...
	<table border="0" cellpadding="2px" width="600px">
		<?php 
			foreach ($p_electronic_view_all as $product){
				$id = $product['serial'];
				$name = $product['name'];
    	...
    	<tr>
            ...
            <td ><br /><b style="color:#000"><?php echo $name; ?></b><br />
                    ...
                    <?php
					echo form_open('products_view/view_details/5');	//here 1 define for dry_fish
