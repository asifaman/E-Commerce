...
$result = mysql_query("SELECT * FROM adminlogin");
...
while($row = mysql_fetch_array($result))
  ...
  echo "<tr>";
			  ...
			  echo "<td><a href=\"delete_form_user_show.php?id=".$row['id']."\" onclick=\"return window.confirm('Are you sure you want to delete?')\">Delete</a></td>";
