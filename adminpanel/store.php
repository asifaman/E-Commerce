...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <li ><a href="create_user.php"><b>CREATE USER</b></a></li>
                     ...
                     <li ><a href="store_insert.php"><b>STORE INSERT</b></a></li>
...
while($row = mysql_fetch_array($result))
  ...
  echo "<tr>";  echo "<td>" . $row['id'] . "</td>";
                  ...
                  echo "<td>" . $row['qty'] . "</td>";
                  echo "<td>" . $row['per_qty_price'] . "</td>";
				  
             
			   
              //echo "<td><a href=\"alert.php?no=".$row['no']."\" >Delete</a></td>";
			  echo "<td><a href=\"delete_form_product.php?id=".$row['id']."\" onclick=\"return window.confirm('Are you sure you want to delete?')\">Delete</a></td>";
