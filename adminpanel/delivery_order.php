...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <li><a href="order_detail.php">Custom Order details</a></li>
                     ...
                     <li ><a href="delivery_order.php"><b>DELIVERY VIEW</b></a></li>
                     <li ><a href="delivery_order_home.php"><b>DELIVERY ORDER INSERT</b></a></li>
                    </ul>
                    </div> 
...
$result = mysql_query("SELECT * FROM delivery_order ORDER BY serial DESC");
...
while($row = mysql_fetch_array($result))
  ...
  echo "<tr>";  echo "<td>" . $row['serial'] . "</td>";
			   ...
			   echo "<td><a href=\"delivery_order_edit.php?serial=".$row['serial']."\">Edit</a></td>";
              //echo "<td><a href=\"alert.php?no=".$row['no']."\" >Delete</a></td>";
			  echo "<td><a href=\"delivery_order_delete.php?serial=".$row['serial']."\" onclick=\"return window.confirm('Are you sure you want to delete?')\">Delete</a></td>";
              echo "<td><a href=\"print_delivery_order.php?serial=".$row['serial']."\">Print</a></td>";
