...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <div class="menu">
                    <ul>
                    <li><a class="current" href="database_electronic_view.php">Electronic Database View</a></li>
...
$result = mysql_query("SELECT * FROM p_electronic_view ORDER BY serial DESC");
...
while($row = mysql_fetch_array($result))
  ...
  echo "<tr>";  echo "<td>" . $row['serial'] . "</td>";
			  ...
			  echo "<td><a href=\"electronic_order_delete.php?serial=".$row['serial']."\" onclick=\"return window.confirm('Are you sure you want to delete?')\">Delete</a></td>";
