...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <div class="menu">
                    <ul>
                    <li><a class="current" href="database_e_book_view_all.php">E-Book Database View All</a></li>
...
$result = mysql_query("SELECT * FROM p_e_book_view_all ORDER BY serial DESC");
