...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <div class="menu">
                    <ul>
                    <li><a class="current" href="database_electronic_all.php">Electronic Products Database View All</a></li>
...
$result = mysql_query("SELECT * FROM p_electronic_view_all ORDER BY serial DESC");
...
while($row = mysql_fetch_array($result))
  ...
  echo "<tr>";  echo "<td>" . $row['serial'] . "</td>";
			  ...
			  echo "<td><a href=\"delete_form_customer.php?serial=".$row['serial']."\" onclick=\"return window.confirm('Are you sure you want to delete?')\">Delete</a></td>";
