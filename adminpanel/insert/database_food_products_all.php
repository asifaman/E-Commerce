...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <div class="menu">
                    <ul>
                    <li><a class="current" href="database_food_products_all.php">Food Products Database View All</a></li>
...
$result = mysql_query("SELECT * FROM p_dry_fish_view_all ORDER BY serial DESC");
