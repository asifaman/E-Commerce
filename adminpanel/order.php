...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <li><a href="order.php">Customer Order</a></li>
...
$result = mysql_query("SELECT * FROM orders ORDER BY serial DESC");
...
while($row = mysql_fetch_array($result))
  ...
  echo "<tr>";
              ...
              echo "<td><a href=\"edit_form.php?serial=".$row['serial']."\">Edit</a></td>";
              //echo "<td><a href=\"alert.php?no=".$row['no']."\" >Delete</a></td>";
			  echo "<td><a href=\"delete_form.php?serial=".$row['serial']."\" onclick=\"return window.confirm('Are you sure you want to delete?')\">Delete</a></td>";
              echo "<td><a href=\"print.php?serial=".$row['serial']."\">Print</a></td>";
  echo "</tr>";
  }
echo "</table>";
}
